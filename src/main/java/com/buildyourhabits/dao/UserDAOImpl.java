...
public class UserDAOImpl implements UserDAO {
    ...
    public RealizationRecurringEvent getRealizationRecurringEventListByRealizationEventId(int eventId) {
        ...
        Query query = currentSession.createQuery("FROM RealizationRecurringEvent WHERE recurringEvent.id =:recurring_event_id");
        query.setParameter("recurring_event_id", eventId);
        query.setMaxResults(1);
//        List<RealizationRecurringEvent> realizationRecurringEventList = query.getResultList();
        RealizationRecurringEvent realizationRecurringEvent = (RealizationRecurringEvent) query.uniqueResult();

        return realizationRecurringEvent;
    }
