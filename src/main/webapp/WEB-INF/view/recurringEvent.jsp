                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <form:form id='form1' action="createRecurringEvent" modelAttribute="recurringEvent"
...
<%--<spring:url value="/resources/Theme/assets/js/jquery.nicescroll.js" var="nicescroll"/>&ndash;%&gt;--%>
